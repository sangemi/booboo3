    ...
    >
      ...
      <LegalSection title="제2조 (용어의 정의)">
        <LegalList>
          ...
          <li>“캐시”란 유료로 충전해 서비스에서 사용할 수 있는 재화를, “포인트”란 활동이나 이벤트 등을 통해 무료로 받을 수 있는 재화를 말합니다.</li>
      ...
      <LegalSection title="제6조 (게시물과 공개 범위)">
        <LegalList>
          ...
          <li>회원이 글이나 댓글에서 선택한 페르소나는 익명 여부와 관계없이 해당 게시물에 표시될 수 있습니다.</li>
